...
function CheckoutAll() {
  ...
  if (cart.length === 0) {
    return <p style={{ textAlign: "center", marginTop: "100px" }}>No products found</p>;
  }

  const goToConfirm = () => {
    navigate("/order-confirm-all", { state: { cart, details } });
  };
  ...
  return (
    <div className="main-container">
      <Navbar />
      <div className="checkout-container">
        <h2 className="checkout-heading">Checkout All</h2>
